  ...
  return (
    ...
    <div className='bg-blue-600'>
      <section className="relative z-10 pt-36 pb-16 md:pb-20 lg:pt-[180px] lg:pb-28 ">
                ...
                <div className="mx-auto mb-9 text-center">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#2D3A4A" stopOpacity="0" />
                        <stop offset="1" stopColor="#2D3A4A" />
                      </linearGradient>
                      <linearGradient
          ...
          >
            ...
            <defs>
              ...
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#2D3A4A" />
                <stop offset="1" stopColor="#2D3A4A" stopOpacity="0" />
              </linearGradient>
              <linearGradient
        ...
        <div id='ending' className="absolute top-0 right-0 z-[-1] hidden sm:block">
          <svg
            width="406"
            height="286"
            viewBox="0 0 406 286"
    ...
    <div id='sec2' className='bg-lime-800'>
      <section className="relative z-10 pt-36 pb-16 md:pb-20 lg:pt-[180px] lg:pb-28 ">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
