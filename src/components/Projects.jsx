    ...
    <>
      ...
      {/*  {projects.map((item, i) => <ProjectCard key={i} item={item} />)}*/} 
          ...
          <div className="grid grid-cols-2 p-10 justify-center items-center gap-8 tablet:grid tablet:grid-cols-1">
            <div className = "w-full pl-16 order-1">
            ...
            <div className = "w-full pl-16 order-2">
          ...
          <div className="grid grid-cols-2 p-10 justify-center items-center gap-8 tablet:grid tablet:grid-cols-1">
            <div className = "w-full pl-16 order-4 tablet:order-3">
              <div className="img-box w-[450px] lg2:w-auto mx-auto flex justify-center items-center relative overflow-hidden rounded-3xl">
            ...
            <div className = "w-full pl-16 order-3 tablet:order-4">
          ...
          <div className="grid grid-cols-2 p-10 justify-center items-center gap-8 tablet:grid tablet:grid-cols-1">
            <div className = "w-full pl-16 order-5">
              <div className="img-box w-[450px] lg2:w-auto mx-auto flex justify-center items-center relative overflow-hidden rounded-3xl">
            ...
            <div className = "w-full pl-16 order-6">
          ...
          <div className="grid grid-cols-2 p-10 justify-center items-center gap-8 tablet:grid tablet:grid-cols-1">
            <div className = "w-full pl-16 order-8 tablet:order-7">
              <div className="img-box w-[450px] lg2:w-auto mx-auto flex justify-center items-center relative overflow-hidden rounded-3xl">
            ...
            <div className = "w-full pl-16 order-7 tablet:order-8">
          ...
          <div className="grid grid-cols-2 p-10 justify-center items-center gap-8 tablet:grid tablet:grid-cols-1">
            <div className = "w-full pl-16 order-9">
              <div className="img-box w-[450px] lg2:w-auto mx-auto flex justify-center items-center relative overflow-hidden rounded-3xl">
            ...
            <div className = "w-full pl-16 order-10">
          ...
          <div className="grid grid-cols-2 p-10 justify-center items-center gap-8 tablet:grid tablet:grid-cols-1">
            <div className = "w-full pl-16 order-12 tablet:order-11">
              <div className="img-box w-[450px] lg2:w-auto mx-auto flex justify-center items-center relative overflow-hidden rounded-3xl">
            ...
            <div className = "w-full pl-16 order-11 tablet:order-12">
          ...
          <div className="grid grid-cols-2 p-10 justify-center items-center gap-8 tablet:grid tablet:grid-cols-1">
            <div className = "w-full pl-16 order-13">
              <div className="img-box w-[450px] lg2:w-auto mx-auto flex justify-center items-center relative overflow-hidden rounded-3xl">
            ...
            <div className = "w-full pl-16 order-14">
