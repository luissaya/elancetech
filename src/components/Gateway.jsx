...
function Gateway() {
  return (
    <div className='bg-gradient-to-b from-slate-600 to-slate-300'>
          ...
          <div id='gateway' className="container flex justify-center mx-auto pt-16 px-10">
            <div>
