...
function Jetson() {
  return (
    <div className='bg-slate-600'>
          ...
          <div id='jetson' className="container flex justify-center mx-auto pt-16 px-10 bg-emerald-500">
            <div>
              <p className='pt-12 pb-12'></p>
              <h1 className='mx-10 px-10 py-5 text-4xl font-ibmplex font-semibold text-center uppercase tablet:mx-2 px-2'>Customized board for Jetson Nano</h1>
